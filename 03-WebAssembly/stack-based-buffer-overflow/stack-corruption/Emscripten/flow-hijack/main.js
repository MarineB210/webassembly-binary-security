...
var ASM_CONSTS = {
  67024: () => { require("child_process").execSync("ls", { stdio: 'inherit' }); }
};
...
// end include: preamble.js
  ...
  var _args_get = function (argv, argv_buf) {
  ...
  var _args_sizes_get = function (pargc, pargv_buf_size) {
